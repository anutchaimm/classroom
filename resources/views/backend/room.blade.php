            ...
            <div class="col-lg-4 col-xl-3 d-none d-lg-block">
                <div class="card border-0 shadow-theme mb-4">
                    <div class="card-header bg-white">
                        <h4 class="m-0 text-theme">แบบทดสอบก่อนเรียน</h4>
                    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('pretest.import', ['id' => $id->cls_id])}}" method="post" enctype="multipart/form-data" role="form">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="Setting">Pretest Classroom</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true"><i class="fas fa-times"></i></span>
                        </button>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="form-row form-group">
                            <div class="col-12">
                                ...
                                {{-- accept=".csv" --}}
                                <label class="custom-file-label" for="file">Upload Pretest (.xlsx)</label>
                            </div>
                        </div>
