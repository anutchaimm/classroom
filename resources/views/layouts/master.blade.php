                ...
                <ul class="list-unstyled components">
                    ...
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="pageSubmenu">
                            ...
                            <li>
                                <a href="{{ route('classroom.show', ['id' => $value->classroomname->cls_id]) }}">{{$value->classroomname->cls_name}}</a>
                            </li>
                            @endforeach
                    ...
                    <li class="list">
                        <a href="{{ route('chat') }}"><i class="fas fa-user-friends pr-2"></i> Chat</a>
                    </li>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand-lg sticky-top">
                    <div class="container-fluid">
                        ...
                        <a class="navbar-brand pl-2 font-weight-bold" href="{{ route('control')}}"><i class="fa fa-home" style="color:white"></i> Main Menu</a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="nav navbar-nav ml-auto">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-avatar" href="#" role="button" id="navbarDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        @if(Auth::user()->profile->prf_img)
                                        <img src="{{asset('storage')}}/{{Auth::user()->profile->prf_img}}" class="avatar" alt="Avatar">
                                        @else
                                        <img src="{{asset('images/user.jpg')}}" class="avatar" alt="Avatar">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right animate slideIn border-0 shadow w-100 mt-2 bg-theme" aria-labelledby="navbarDropdown">
