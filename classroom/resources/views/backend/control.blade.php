...
@section('content')
            ...
            <div class="container-fluid mt-4 mb-4 pb-4">
                ...
                @foreach ($classroom as $item)
                        ...
                        <div class="col mb-4">
                            <a href="{{ route('classroom.show', ['id' => $class->cls_id]) }}">
                                <div class="card card-classroom h-100 shadow-theme border-0">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">{{$class->cls_name}}</h5>
                                        @if($class->imgowner)
                                            <img src="{{asset('storage')}}/{{$class->imgowner}}" class="card_teacher">
                                        @else
                                            <img src="images/img1.jpg" class="card_teacher">
                                        @endif
                                        <p class="card-text">{{$class->cls_subject}}</p>
                                    </div>
                                    <div class="card-footer clearfix bg-blue">
                                        <small class="text-white float-left"><i class="fas fa-book"></i> {{$class->cls_level}}</small>
