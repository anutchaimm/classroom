                                    ...
                                    <div class="row d-flex">
                                        <div class="col-8">
                                            <div class="text-left text-theme ">
                                                <a href="#">
                                                    <h4 class="m-0">
                                                        <i class="fas fa-arrow-left text-theme fa-sm pr-2 d-none d-lg-block"
                                                            onclick="goBack()"></i>
                                        ...
                                        <div class="col-md-2 text-right pt-3">
                                            <a href="{{route('match.createround', ['id' => $id])}}" class="btn btn-theme btn-block btn-sm">จับคู่</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="card border-0 shadow-theme mb-4 card-schedule-left">
                                                    <div class="row card-body">
                                                        ...
                                                        <img src="{{asset('images/user.jpg')}}"
                                                            class="avatar-schedule-right d-none d-md-block">
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12 text-center col-lg-2 mb-3">
                                                ...
                                                @if($item->com_status <> "Finished")
                                                    <button class="btn btn-white rounded-circle shadow-sm edit-modal pb-5"
                                                    data-scd_id="{{$item->scd_id}}"
                                                    data-div_id="{{$item->div_id}}"
                                                    data-com_user1="{{$item->com_user1}}"
                                                    data-com_scoreuser1="{{$item->com_scoreuser1}}"
                                                    data-com_user2="{{$item->com_user2}}"
                                                    data-com_scoreuser2="{{$item->com_scoreuser2}}"
                                                    data-com_realname1="{{$item->com_realname1}}"
                                                    data-com_realname2="{{$item->com_realname2}}">
                                                        <span class="d-block">VS</span>
                                                        <small class="d-block" id="result{{$item->scd_id}}">{{$item->com_status}}</small>
                                                    </button>
                                                @else
                                                    <button class="btn btn-white rounded-circle shadow-sm pb-5">
                                                        <span class="d-block">{{$item->com_result}}</span>
                                                    </button>
                                                @endif
                                                ...
                                                @can ('update', $owner->profile)
                                                    ...
                                                    @if($item->com_status == "Waiting")
                                                        <a href="javascript:void(0)" role="button" data-scd_id="{{$item->scd_id}}" class="btn btn-outline-info btn-sm text-info confrimScore">Confrim</a>
                                                    @endif

                                                    @if($item->com_status == "Finished")
                                                        <a href="javascript:void(0)" role="button" data-scd_id="{{$item->scd_id}}" class="btn btn-outline-danger btn-sm text-danger cancelScore">Cancel</a>
                                                    @endif
                                            ...
                                            <div class="col-12 col-lg-5">
                                                <div class="card border-0 shadow-theme mb-4 card-schedule-right">
                                                    <div class="row card-body">
                                                        ...
                                                        @else
                                                        <img src="{{asset('images/user.jpg')}}"
                                                            class="avatar-schedule-left d-none d-md-block">
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
...
@stop
                                ...
                                <div class="form-row">
                                    <div class="col-12 mb-2">
                                        <div class="input-group">
                                            ...
                                            <input type="number" id="com_scoreuser1" name="com_scoreuser1" min="0" max="20" value="0" class="form-control"
                                                placeholder="score" aria-describedby="user-score-1" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text bg-theme"
                                                    id="com_realname2"></span>
                                            </div>
                                            <input type="number" id="com_scoreuser2" name="com_scoreuser2" min="0" max="20" class="form-control"
                                                placeholder="score" aria-describedby="user-score-2" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '.confrimScore', function () {
        ...
        $('body').on('click', '.cancelScore', function () {
            var match_id = $(this).data("scd_id");
            //confirm("Are You sure want to delete !");
