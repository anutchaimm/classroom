                                        ...
                                        <div class="card-body">
                                            <form action="{{route('schedule.store', ['id' => $classroom->cls_id])}}" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    <textarea class="form-control" placeholder="Division Name..." name="name"
                                                        id="" rows="2" required></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <textarea class="form-control" placeholder="Division Description..." name="role"
                                                        id="" rows="5" required></textarea>
                                                </div>
                                                <div class="form-row">
                                                ...
                                                <div class="clearfix">
                                                    <div class="float-right">
                                                        <button type="submit"
                                                            class="btn btn-theme rounded px-5 btn-block text-uppercase">
                                                            Create
                                                        </button>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="dropdown d-inline dropdown_post">
                                                @can ('update', $owner->profile)
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right animate slideIn border-0 shadow"
                                                        ...
                                                        data-id="{{$division->div_id}}"
                                                        data-name="{{$division->div_name}}"
                                                        data-win="{{$division->div_win}}"
                                                        data-draw="{{$division->div_draw}}"
                                                        data-lose="{{$division->div_lose}}"
                                                        data-role="{{$division->div_role}}">
                                        ...
                                        <div class="card-body " id="item{{$division->div_id}}">
                                            ...
                                            @foreach ($division_member as $teammember)
                                                @if($teammember->div_id == $division->div_id)
                                                    <p class="card-text"><i class="fas fa-user"></i> {{$teammember->prf_firstname}} {{$teammember->prf_lastname}}</p>
                                                @endif
                                            @endforeach
                                            <div class="pt-2">
                                                @can ('update', $owner->profile)
                                                ...
                                                @endcan
                                                <a class="role-modal" data-name="{{$division->div_name}}"
                                                    data-rule="{{$division->div_role}}"
                                                    data-win="{{$division->div_win}}"
                                                    data-draw="{{$division->div_draw}}"
                                                    data-lose="{{$division->div_lose}}">
                                        ...
                                        @foreach ($division_list as $key => $item)
                                            <div class="form-check">
                                                <label class="form-check-label" for="check1">
                                                    <input type="checkbox" class="input" id="checkbox-1" name="option[]" value="{{$item->user_id}}"> {{$item->prf_firstname}} {{$item->prf_lastname}}
                                                </label>
                                            </div>
                                        @endforeach
                                    </div>
                            ...
                            <form id="change_name" class="form-horizontal" role="form">
                                @csrf
                                    <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <textarea class="form-control" name="names" id="rulenames" rows="1" disabled>Description</textarea>
                                            </div>
                                            <div class="form-group">
