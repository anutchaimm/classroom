                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="d-none d-lg-block">
                            <a href="#">
                                <h4 class="m-0" onclick="goBack()"><i
                                        class="fas fa-arrow-left text-white fa-sm pr-2"></i>
                                </h4>
                            </a>
                        </div>
                        ...
                        <div class="card mb-4 border-0 shadow-theme">
                            <div class="card-header clearfix bg-blue">
                                <div class="float-left post">
                                    ...
                                    <img src="{{asset('images/user.jpg')}}" class="avatar-haeding"> <span
                                        class="text-white">{{$content->profile->prf_firstname}}
                            ...
                            <div class="card-body mt-3">
                                ...
                                <h6>ความคิดเห็นทั้งหมด ({{$content->classroomcomment->count()}})</h6>
                            </div>
                                ...
                                <div class="d-flex">
                                    ...
                                    <form id="change_name" class="d-block w-100">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" id="txt_comment" name="comment" class="form-control rounded-pill"
