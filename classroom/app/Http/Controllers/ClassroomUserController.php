...
class ClassroomUserController extends Controller
{
    ...
    public function destroy(Request $request)
    {
        ...
        if($request->ajax()){
            try{
                ClassroomComment::where('user_id',$request->user_id)->delete();
                ClassroomDivisionUser::where('user_id',$request->user_id)->delete();
                ClassroomUser::where('user_id',$request->user_id)->delete();
                ClassroomContent::where('user_id',$request->user_id)->delete();
                DB::commit();
