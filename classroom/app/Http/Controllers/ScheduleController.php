...
class ScheduleController extends Controller
{
    ...
    public function index($id)
    {
        ...
        if($userid == $owner->user_id){
            ...
            $match = DB::table('classroom_schedules')
                ->where('classroom_schedules.div_id', '=', $id)
                ->where('classroom_schedules.com_user1', $userid)
                ->orWhere('classroom_schedules.com_user2', $userid)
                ->get();
        ...
        return view('backend.all_schedule',compact('id','match','classroom','owner'));
    }
